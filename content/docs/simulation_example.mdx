...
description: A BEAM-native blueprint that stresses MirrorNeuron with stateful regions and multi-agent interaction.
---
...
For first-time setup, use [Quickstart](quickstart.mdx) instead.

## Related Pages

- [Examples](examples.mdx)
- [Runtime Architecture](runtime-architecture.mdx)
- [Cluster Guide](cluster.mdx)
- [Reliability Guide](reliability.mdx)
---
