---
title: "Nomad-Inspired Runtime Features"
description: "Documentation for Nomad-Inspired Runtime Features."
---
...
| --- | --- | --- |
| Reconciliation and automatic rescheduling | Implemented | [Reliability Guide](/reliability) and [Cluster Guide](/cluster) |
| Full job type behavior | Implemented | [Reliability Guide](/reliability) |
| Restart and reschedule policies | Implemented | [Reliability Guide](/reliability) |
| Node drain and maintenance | Implemented | [Cluster Guide](/cluster) |
| Service registry and health checks | Implemented | [Services and Health Checks](/services-and-health-checks) |
| Stronger resources and devices | Implemented | [Resources and Devices](/resources-and-devices) |
| Deployment and update strategy | Implemented | [Deployments](/deployments) |
| Periodic, delayed, and event-triggered jobs | Implemented | [Schedules and Events](/schedules-and-events) |
