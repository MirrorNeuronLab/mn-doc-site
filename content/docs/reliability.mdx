...
description: "Documentation for Reliability Guide."
---
...
See [Redis High Availability](/redis-ha) for setup and smoke tests.
...
- [Schedules and Events](/schedules-and-events)
