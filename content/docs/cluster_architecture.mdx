---
title: "MirrorNeuron Clustering Architecture"
description: "Documentation for MirrorNeuron Clustering Architecture."
---
...
See [Nomad-Inspired Runtime Features](/nomad-inspired-runtime), [Reliability Guide](/reliability), and [Cluster Guide](/cluster).
...
Very high worker counts across a small two-node development setup can exhaust CPU and networking file descriptors, causing nodes to miss Erlang heartbeats (`timed out waiting for recovered agent ...`).
