...
- Runtime and scheduling changes: [Runtime Architecture](/runtime-architecture), [Reliability Guide](/reliability), and [Cluster Architecture](/cluster_architecture).
- CLI or API changes: [CLI Reference](/cli), [API Reference](/api), and [Environment Variables](/env_variables).
- Blueprint behavior: [Blueprints and Skills](/blueprints-and-skills), [Blueprint Standard](/blueprint-standard), and [Examples](/examples).
- Installation, service, model, or OpenShell changes: [Installation](/installation), [Model Runtime](/model-runtime), and [Docker and OpenShell for Blueprints](/docker_and_openshell_for_blueprints).
- Cross-component changes: [Testing](/testing) and [Contributing](/contributing).
