---
title: "Cluster Guide"
description: "Documentation for Cluster Guide."
---

# Cluster Guide

MirrorNeuron can run on a single laptop, an edge device, or a small heterogeneous cluster. Multiple machines can connect as a swarm, pooling available CPU, GPU, and memory resources to execute AI agents and workflows across local infrastructure. Agents can run natively or inside sandboxes, and workflows can be fully dynamic, agent-driven, or pre-defined like traditional software pipelines.
The goal of MirrorNeuron is to help individuals and small teams build reliable, scalable, and repeatable AI-powered workflows that create business value without depending entirely on centralized cloud infrastructure.
...
See [Redis High Availability](/redis-ha) for Sentinel setup and failover tests.
...
See [Resources and Devices](/resources-and-devices) for the full resource model.
...
Submit a reviewed blueprint that is suitable for your cluster's available resources:
...
- [Nomad-Inspired Runtime Features](/nomad-inspired-runtime)
- [Reliability Guide](/reliability)
- [Resources and Devices](/resources-and-devices)
- [Services and Health Checks](/services-and-health-checks)
