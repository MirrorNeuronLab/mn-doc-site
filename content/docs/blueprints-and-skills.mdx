---
title: "Blueprints And Skills"
description: "Documentation for Blueprints And Skills."
---
...
Compile your own decorated workflow into a local bundle, then validate the output:
...
- Workflow-specific code belongs in the owning blueprint folder, such as `otterdesk-blueprints/<blueprint_id>`.
