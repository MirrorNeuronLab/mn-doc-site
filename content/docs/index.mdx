...
description: "Documentation for MirrorNeuron local AI runtime."
---

# MirrorNeuron Documentation

MirrorNeuron is a durable runtime and control plane for adaptive, message-driven AI workflows built for local and edge environments. It is designed for applications where low latency, privacy, reliability, or offline operation are critical.
...
1. [Quickstart](quickstart.md): validate and run your first workflow.
2. [Installation](installation.md): install runtime dependencies and start local services.
